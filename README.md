...
* поддержка критичных для production ПО требований
  * импорт/экспорт конфигураций в текстовые файлы:
совместимость с любыми системами контроля версий (git, mercurial,...)
  * полноценная реализация ООП с наследованием
  * поддержка регрессионного тестирования
  * сквозное редактирование и динамическая отладка кода ядра в runtime
